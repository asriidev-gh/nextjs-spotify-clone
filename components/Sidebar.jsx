...
const Sidebar = ({ view, setView, setGlobalPlaylistId }) => {
  ...
  return (
    <div className="w-64 text-neutral-400 grow-0 shrink-0 h-screen overflow-y-scroll-hidden border-r border-neutral-900 p-5 text-sm hidden md:inline-flex">
      <div className="space-y-4">
        ...
        <button
          onClick={() => setView('japanese')}
          className="flex items-center space-x-2 hover:text-white"
        >
          <HeartIcon className="h-5 w-5" />
          <p>Japanese Language Tutorial</p>
        </button>
